...
def get_agent():
    # Updated to the new Groq recommended models post-August 16
    tool_caller_llm = ChatGroq(model="qwen3.6-27b", temperature=0)
    reasoning_llm = ChatGroq(model="qwen3.6-27b", temperature=0.2)
